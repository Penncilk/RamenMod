...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ramen':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/ramen','shared');
				frames = tex;
				animation.addByPrefix('idle', 'ramenIdol0', 24, false);
				animation.addByPrefix('singUP', 'ramenUp0', 24, false);
				animation.addByPrefix('singLEFT', 'ramenLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'ramenRight0', 24, false);
				animation.addByPrefix('singDOWN', 'ramendown0', 24, false);

				addOffset('idle', 61, 77);
				addOffset("singUP", -11, 54);
				addOffset("singRIGHT", -100, 34);
				addOffset("singLEFT", -92, -27);
				addOffset("singDOWN", 29, 72);
